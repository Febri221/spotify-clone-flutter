...
import 'package:percobaan/data/lyric_database.dart';
...
class AudioManager {
  ...
  void _initSmartStream() {
    // --- THE GOLDEN FIX: CombineLatest4 ---
    // Menggabungkan 4 Stream menjadi 1 logic yang utuh.
  ...
  void _attachListeners() {
    ...
    player.playerStateStream.listen((playerState) {
      ...
      // HAPUS SEMUA LOGIKA MANUAL .ADD DI SINI
      // Biarkan Stream di atas yang bekerja otomatis.
    ...
    player.sequenceStateStream.listen((sequenceState) async {
      ...
      if (rawLrc.isNotEmpty) {
        ...
        overlayData = [
          ...
          {'time': 5000, 'text': 'Silakan request ke yang punya App yaa!'}
        ];
      }
